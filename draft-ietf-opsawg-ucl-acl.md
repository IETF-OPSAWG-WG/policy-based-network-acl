...
# Introduction {#intro}
   ...
   *  Endpoints do not have stable and unique IP addresses.  For example, Wireless
      ...
      result. Furthermore, mechanisms such as IPv6 temporary addresses {{?RFC8981}}, Happy Eyeballs {{?RFC8305}}, and Network Address Port Translation (NAPT) {{?RFC3022}} may further contribute to address instability and non-uniqueness. This complicates the consistent and efficient access control policy enforcement relying on IP/transport fields (e.g., the
